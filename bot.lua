...
----config----
local bot_api_key = "285510221:AAG00Sp_A3HzwPEehTsa3hswYmtcjlQokOM" --BOT TOKEN تو کن ربات خود را در اینجا قرار دهید
local You = 119296662  --ID ADMIN ایدی خود را اینجا قرار دهید
...
local function do_keyboard_private()
    ...
    keyboard.inline_keyboard = {
    {
		...
		{
			{text='👤PV SUDO',url='http://telegram.me/xsudox'},
		},
    }
    return keyboard
end
